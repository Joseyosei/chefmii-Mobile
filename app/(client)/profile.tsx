...
function ProfileMenuItem({ icon, label, onPress, danger }: { icon: any; label: string; onPress: () => void; danger?: boolean }) {
    ...
    <ScreenContainer>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="px-5">
          ...
          <ProfileMenuItem icon="person.fill" label="Edit Profile" onPress={() => {}} />
          ...
          <ProfileMenuItem icon="info.circle.fill" label="How ChefMii Works" onPress={() => {}} />
          <ProfileMenuItem icon="shield.fill" label="Privacy Policy" onPress={() => {}} />
          <ProfileMenuItem icon="doc.fill" label="Terms of Service" onPress={() => {}} />
