      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
        ...
        <View className="px-5 pt-4 pb-3 flex-row items-center gap-3 border-b border-border">
          ...
          <View className="flex-1">
            ...
            <Text className="text-muted text-xs">Chat with your chef</Text>
          </View>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View className="items-center py-16">
                ...
                <Text className="text-foreground font-semibold">Start the conversation</Text>
                <Text className="text-muted text-center mt-1 text-sm">
                  Send a message to your chef about the booking
                </Text>
              </View>
            }
            renderItem={({ item: msg }) => {
